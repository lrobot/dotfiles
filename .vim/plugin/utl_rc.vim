...
if has("win32")
    ...
    let g:utl_rc_app_browser = 'silent !start D:\bin\FireFox\FirefoxPortable.exe %u' 
    "let g:utl_rc_app_browser = 'silent !start D:\bin\Firefox\App\firefox\firefox.exe %u' 
    "
...
elseif has("unix")
    ...
    let g:utl_rc_app_browser = "silent !myfirefox -remote 'ping()' && myfirefox -remote 'openURL( %u )' || myfirefox '%u' &"
    "	Samples for other browsers are welcome!
